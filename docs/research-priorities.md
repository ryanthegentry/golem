...
All P0 items resolved with live validation on mutinynet. End-to-end test: faucet → on-chain receive → board into Ark → OOR send 21,000 sats to Ark Labs maintainer (Ark Labs CEO) → balance update → transaction history.
