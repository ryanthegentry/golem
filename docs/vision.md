...
**Ryan Gentry (CEO / Product):** Domain expertise in Bitcoin protocols, Lightning Network, and Ark architecture. Direct relationship with Ark Labs maintainer (Ark Labs CEO). Built 402index.io and Golem prototype. Previously at Lightning Labs. Relationships with all major Bitcoin VCs and wallet teams.
