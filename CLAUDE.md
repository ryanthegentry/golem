...
- **Claw Cash** (https://clw.cash/) = Tiero's own agent wallet on Ark. Custodial (Evervault Enclave). No multisig, no covenants, no L402. Complementary, not competitive — Claw Cash = custodial convenience, Golem = self-custodial with L402 standard.

## Current Phase: Phase 1 PoC

Working testnet wallet with automated refresh, dual-mode L402 gateway, and CLI. Live on mutinynet and mainnet. 336 passing tests.
