 ...
 * Goal 4: Structured summary for Tiero
 *
 * Prerequisites:
 *   nigiri start --ci
...
async function main() {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // GOAL 3: Recursive Covenant Prototype — Tiero's Approach
  // ═══════════════════════════════════════════════════════════════════════════
  ...
  log('');
  log('Tiero\'s approach: reconstruct the VTXO scriptPubKey on the stack from:');
  ...
  log('');
  log('2. On-stack scriptPubKey reconstruction (Tiero\'s suggestion):');
